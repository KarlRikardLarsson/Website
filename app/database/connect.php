...
$host ='utbweb.its.ltu.se:3308';
$user = 'akaloa0';
$password ='gfdsz7pE';
$db_name ="D0019E_V22_akaloa0";

$conn = new mysqli($host, $user, $password, $db_name);



//Allt nedan är taget från db.php i moduler .

//om connection inte funker, blir det error
...
function db_connect()
{
    ...
    $DB_SERVER = "utbweb.its.ltu.se:3308";
    $DB_USER = "akaloa0";
    $DB_PASS= "gfdsz7pE";
    $DB_NAME = "D0019E_V22_akaloa0";
